...
export default function ForgotPasswordPage() {
  ...
  const submit = async ({ email }: { email: string }) => { setError(""); try { await authService.requestPasswordReset(email); setSent(true); } catch (caught) { setError(getErrorMessage(caught)); } };
